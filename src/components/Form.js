		...
		return (
			<Form className="form" onSubmit={e => this.handleFormSubmit(e)}>
				<Row>
					<Col md="6">
						<FormGroup>
							<Label for="customerName" className="display-4 text-white">Name</Label>
					...
					<Col md="6">
						<FormGroup>
							<Label for="customerEmail" className="display-4 text-white">Email</Label>
				...
				<Row>
					<Col md="6">
						<FormGroup>
							<Label for="customerPhone" className="display-4 text-white">Phone</Label>
